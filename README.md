...
│
├── Dataset/                       # Original dataset files from Kaggle 
|
├── Images/                        # Tableau screenshots 
│
├── SQL_Codes.sql/                 # All sql queries usedin this project       
│
├── README.md                   
|
├── LICENSE                     
|
└── Solutions_and_Visualization.md
```
...
<img src="Images/Sheet 3 (1).png" alt="Order Status Distribution" width="99%" />
...
<img src="Images/Sheet 9.png" alt="Sales by State" width="99%" />
...
<img src="Images/Sheet 8a.png" alt="Delivery Time Analysis" width="99%" />
